                ...
                <Typography>
                  <ul>
                    <li>
                      ...
                      fundamentals. I dont think it's necessary but I'm glad I
                      took the course because I learned a lot of useful
                ...
                <Typography>
                  <ul>
                    <li>
                      ...
                      supported by an open source community. They literally set
                      up an entire path for getting started in web development,
                      compiled all the best free resources to use and present it
                      in logical order. There is a TON of useful content on
                      ...
                      tools on your own. You can learn a lot on odin, the only
                    ...
                    <li>
                      ...
                      is a teaching platform where you can learn from
                      interactive tutorials and projects, they even come with
                      certificates if you complete everything in the course.
                      This is the only platform I've paid for so far that I've
                      found to be worth it. There's a lot of different content
                      on there for beginners, intermediate and advanced
                      developers. I saw a lot of recommendations for their Front
                      End Developer course but I was too advanced to get a lot
                      of use from it. The membership comes with access to all
                      the courses so I looked around and started their more
                      advanced courses for React and TypeScript. I really like
                      them so far, it's probably the only platform I've used I
                    ...
                    <li>
                      ...
                      something that's very intuititive. I dont use it too much
                    ...
                    <li>
                      ...
                      just stricly Web Development. There is also courses on
                      ...
                      Python later but for now I am focusing stricly on Web
